package com.bahadur.bahadurapp.constant;
...
public class ConstantValues {
    ...
    //*********** API Base URL ********//
    public static final String ECOMMERCE_URL = "https://bahadur.xyz/";
    
    public static final String ECOMMERCE_CONSUMER_KEY = "6df56cf915318431043dd7a75d";
    public static final String ECOMMERCE_CONSUMER_SECRET = "95032b42153184310488f5fb8f";
  ...
  /*  public static final String ECOMMERCE_URL = "http://demo2.androidecommerce.com/";
    ...
    public static final String CODE_VERSION = "3.4";
