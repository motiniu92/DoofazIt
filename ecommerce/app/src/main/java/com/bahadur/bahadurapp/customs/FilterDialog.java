package com.bahadur.bahadurapp.customs;
...
import com.bahadur.bahadurapp.adapters.FilterProductsAdapter;
import com.bahadur.bahadurapp.models.filter_model.get_filters.FilterDetails;
import com.bahadur.bahadurapp.models.filter_model.post_filters.FiltersAttributes;
import com.bahadur.bahadurapp.models.filter_model.post_filters.FiltersPrice;
...
public abstract class FilterDialog extends Dialog {
    ...
    public FilterDialog(Context context, int categoryID, List<FilterDetails> filtersList, double maxPrice) {
        super(context);
