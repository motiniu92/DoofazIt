...
class DistrictListAdapter(val list: ArrayList<District>, val context: Context):RecyclerView.Adapter<DistrictListAdapter.ViewHolder> (){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.cardView.setOnClickListener(View.OnClickListener {
            ...
            val intent=Intent(context, ThanaActivity::class.java)
            SharedPrefManager.getInstance(context)?.saveSelectedThanaid(list.get(position).id)
