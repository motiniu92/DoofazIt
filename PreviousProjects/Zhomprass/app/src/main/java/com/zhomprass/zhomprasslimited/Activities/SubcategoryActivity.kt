...
class SubcategoryActivity : AppCompatActivity() {
    ...
    private fun setUpViewPagger() {
        ...
        adapter?.addFragment(Subcategory_Fragment())
        adapter?.addFragment(BrandsFragmentSub())
        adapter?.addFragment(ShopsFragment())


        tabLayout!!.addTab(tabLayout!!.newTab().setText(SharedPrefManager.getInstance(this)?.getSelectedCatagoryName()))
