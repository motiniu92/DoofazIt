...
class RecentProductAdapter(val list:ArrayList<RecentProduct>,val context: Context) : RecyclerView.Adapter<RecentProductAdapter.ViewHolder>() {
    ...
    class ViewHolder(view:View):RecyclerView.ViewHolder(view){
        ...
        val cardView=view.findViewById<CardView>(R.id.offerCardId)
