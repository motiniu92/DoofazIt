...
class ThanaListAdapter(val list: ArrayList<Thana>, val context: Context):RecyclerView.Adapter<ThanaListAdapter.ViewHolder> (){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.cardView.setOnClickListener(View.OnClickListener {
            ...
            val intent=Intent(context, BazarActvity::class.java)
            SharedPrefManager.getInstance(context)?.saveSelectedBazarid(list.get(position).id)
